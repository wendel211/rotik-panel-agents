  ...
  return (
    <Dialog aberto={Boolean(detalhes)} aoFechar={aoFechar} ariaLabelledby="titulo-limite">
      <div className="px-6 py-6 sm:px-8 sm:py-8">
        ...
        <h2 className="mt-5 text-2xl font-semibold tracking-tight text-ink" id="titulo-limite">Cota mensal esgotada</h2>
        ...
        <p className="mt-5 text-sm leading-6 text-muted">Para liberar antes da próxima competência, o plano do cliente precisa ser ampliado.</p>

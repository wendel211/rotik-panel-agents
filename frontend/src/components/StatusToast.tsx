...
export function StatusToast({ aviso, aoFechar }: StatusToastProps) {
  ...
  return (
    <AnimatePresence>
      {aviso && (
        <motion.div
          className="fixed bottom-5 right-5 z-50 flex max-w-[calc(100%-2.5rem)] items-start gap-3 rounded-xl border border-hairline bg-panel px-4 py-3.5 shadow-[0_20px_55px_-24px_rgba(6,16,43,.55)] sm:max-w-sm"
